...
func (s *Controller) ensureRuntime(agentID string) (sandbox.Runtime, error) {
...
func (s *Controller) ensureRuntimeAtHome(homeDir string) (sandbox.Runtime, error) {
...
func (s *Controller) lookupBootstrapManager(ctx context.Context) (sandbox.Runtime, sandbox.Instance, error) {
...
func (s *Controller) hasBootstrapManagerRecord() bool {
	if s == nil {
		return false
	}
	s.mu.RLock()
...
func (s *Controller) getBox(ctx context.Context, rt sandbox.Runtime, idOrName string) (sandbox.Instance, error) {
...
func (s *Controller) startBox(ctx context.Context, box sandbox.Instance) error {
...
func (s *Controller) stopBox(ctx context.Context, box sandbox.Instance, opts sandbox.StopOptions) error {
...
func (s *Controller) boxInfo(ctx context.Context, box sandbox.Instance) (sandbox.Info, error) {
...
func (s *Controller) createBox(ctx context.Context, rt sandbox.Runtime, spec sandbox.CreateSpec) (sandbox.Instance, error) {
...
func (s *Controller) runBoxCommand(ctx context.Context, box sandbox.Instance, name string, args []string, w io.Writer) (int, error) {
...
func (s *Controller) closeBox(box sandbox.Instance) error {
	if box == nil {
		return nil
	}
...
func (s *Controller) closeRuntime(homeDir string, rt sandbox.Runtime) error {
	if rt == nil {
		return nil
	}
	s.mu.Lock()
...
func (s *Controller) sandboxRuntimeHome(agentID string) (string, error) {
