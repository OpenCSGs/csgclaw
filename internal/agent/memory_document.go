...
func (s *Service) SupportsMemory(runtimeKind string) bool {
...
func (s *Service) MemoryDocument(ctx context.Context, id string) (MemoryDocument, error) {
	got, ok := s.Agent(id)
	if !ok {
...
func (s *Service) UpdateMemoryEnabled(ctx context.Context, id string, enabled bool) (MemoryDocument, error) {
	if s == nil {
