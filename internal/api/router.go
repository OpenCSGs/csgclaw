...
func (h *Handler) registerCoreRoutes(router chi.Router) {
	...
	router.Route("/api/v1", func(r chi.Router) {
		...
		r.Route("/agent-runtimes", func(r chi.Router) {
			...
			r.Get("/{name}/install", h.getAgentRuntimeInstallation)
		...
		r.Route("/agents", func(r chi.Router) {
			...
			r.Route("/{id}", func(r chi.Router) {
				...
				r.Get("/connectors", h.handleAgentConnectors)
				r.Post("/connectors", h.handleAgentConnectors)
				r.Post("/connectors:probe", h.handleAgentConnectorsProbe)
				r.Get("/connectors/{installation_id}", h.handleAgentConnectorBinding)
				r.Patch("/connectors/{installation_id}", h.handleAgentConnectorBinding)
				r.Delete("/connectors/{installation_id}", h.handleAgentConnectorBinding)
				r.Post("/connectors/{installation_id}/{app_action:connect|disconnect}", h.handleAgentConnectorBinding)
				r.Post("/connectors/{installation_id}/oauth/start", h.handleConnectorOAuthStart)
				r.Handle("/mcp", http.HandlerFunc(h.handleAgentConnectorMCP))
				r.Get("/", h.getAgent)
		...
		r.Route("/connectors", func(r chi.Router) {
			r.Get("/catalog", h.handleConnectorCatalog)
			r.Get("/catalog/{app_id}", h.handleConnectorCatalog)
			r.Get("/resources", h.handleConnectorResources)
			r.Post("/resources", h.handleConnectorResources)
			r.Post("/resources:probe", h.handleConnectorResourceProbe)
			r.Get("/resources/{resource_id}", h.handleConnectorResources)
			r.Patch("/resources/{resource_id}", h.handleConnectorResources)
			r.Delete("/resources/{resource_id}", h.handleConnectorResources)
		...
		r.Route("/rooms", func(r chi.Router) {
			...
			r.Route("/{id}", func(r chi.Router) {
				...
				r.Post("/tasks", h.handleCreateRoomTask)
				r.Post("/tasks/retry-delivery", h.handleRetryRoomDelivery)
				r.Post("/tasks/{task_id}/report", h.handleReportRoomTask)
				r.Post("/tasks/{task_id}/plan", h.handlePlanRoomTask)
				r.Post("/tasks/{task_id}/start", h.handleStartRoomTask)
				r.Post("/tasks/{task_id}/claim", h.handleClaimRoomTask)
				r.Post("/tasks/{task_id}/dispatch", h.handleDispatchRoomTask)
				r.Post("/tasks/{task_id}/review", h.handleReviewRoomTask)
				r.Post("/tasks/{task_id}/stop", h.handleRoomTaskStop)
				r.Post("/tasks/{task_id}/recover", h.handleRoomTaskRecover)
				r.Get("/tasks/{task_id}/events", h.handleRoomTaskEvents)
				r.Post("/tasks/{task_id}/messages", h.handleRoomTaskMessage)
				r.Patch("/tasks/{task_id}", h.handleUpdateRoomTask)
		...
		r.Get("/tasks/{task_id}", h.getGlobalTask)
	})
}
