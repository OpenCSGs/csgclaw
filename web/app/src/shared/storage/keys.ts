...
export const CONVERSATION_CITATION_PANEL_WIDTH_STORAGE_KEY = "csgclaw.im.conversationCitationPanelWidth" as const;
export const DOCUMENT_PREVIEW_PANEL_WIDTH_STORAGE_KEY = "csgclaw.im.documentPreviewPanelWidth" as const;
...
export const AGENT_CREATION_WARNINGS_STORAGE_KEY = "csgclaw.im.agentCreationWarnings" as const;
...
export const HUB_RESOURCE_TYPE_STORAGE_KEY = "csgclaw.im.hubResourceType" as const;
