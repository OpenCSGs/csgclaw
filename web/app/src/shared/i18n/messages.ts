export const messages = {
  zh: {
    ...
    resourcesSkillUploadSubtitle: "上传 zip，或从社区列表选择 skill。",
    resourcesSkillUploadZipTab: "上传 zip",
    resourcesSkillRemoteInstallTab: "社区安装",
    resourcesSkillRemoteSkillsLoading: "正在加载社区 skills...",
    resourcesSkillRemoteSkillsEmpty: "暂无社区 skills。",
    resourcesSkillRemoteSkillsLoadFailed: "社区 skills 加载失败，请稍后重试。",
    resourcesSkillRemoteInstallAction: "安装",
    resourcesSkillRemoteReplaceAction: "替换",
    resourcesSkillRemoteInstalling: "安装中...",
    resourcesSkillRemoteInstallFailed: "社区 skill 安装失败，请稍后重试。",
    resourcesSkillRemoteRefresh: "刷新",
    resourcesSkillRemoteSearchPlaceholder: "搜索社区 skill",
    ...
    scheduledTaskCreateSubtitle: "选择 Agent、提示词和触发计划。每次触发都会创建一条普通任务。",
    ...
    scheduledTaskAgentLabel: "执行 Agent",
    scheduledTaskAgentPlaceholder: "请选择 Agent",
    scheduledTaskAgentRequired: "请选择执行 Agent。",
    ...
    modelProviderCreateTitle: "添加 OpenAI API",
  ...
  en: {
    ...
    resourcesSkillUploadSubtitle: "Upload a zip file, or choose a skill from the community list.",
    ...
    resourcesSkillRemoteSkillsEmpty: "No community skills yet.",
    resourcesSkillRemoteSkillsLoadFailed: "Failed to load community skills. Please try again later.",
    ...
    resourcesSkillRemoteInstallFailed: "Failed to install the community skill. Please try again later.",
    ...
    scheduledTaskCreateSubtitle: "Choose an agent, prompt, and schedule. Each trigger creates a normal task.",
