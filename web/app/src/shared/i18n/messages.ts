export const messages = {
  zh: {
    ...
    configSettingsHubOfficialURL: "官方 Hub 地址",
    ...
    hubSkillsLabel: "技能",
    hubSkillsLoading: "正在加载 skills...",
    hubSkillsEmpty: "当前没有可用 skills。",
    hubSkillsLoadFailed: "Skills 加载失败，请稍后重试。",
    hubSkillFilesLoading: "正在加载 skill 文件...",
    hubSkillFilesEmpty: "当前 skill 暂无文件。",
    hubSkillFilesLoadFailed: "Skill 文件加载失败，请稍后重试。",
    hubSkillPreviewTitle: "选择一个文件查看内容",
    hubSkillPreviewHint: "在左侧文件树中选择 skill 文件以查看其内容",
    hubSkillFileLoadFailed: "Skill 文件内容加载失败，请稍后重试。",
    hubSkillUpload: "上传 skill",
    hubSkillUploadSubtitle: "上传 zip，或从官方远端列表选择 skill。",
    hubSkillUploadZipTab: "上传 zip",
    hubSkillRemoteInstallTab: "远端安装",
    hubSkillRemoteSkillsLoading: "正在加载远端 skills...",
    hubSkillRemoteSkillsEmpty: "暂无远端 skills。",
    hubSkillRemoteSkillsLoadFailed: "远端 skills 加载失败，请稍后重试。",
    hubSkillRemoteInstallAction: "安装",
    hubSkillRemoteInstalling: "安装中...",
    hubSkillRemoteInstallFailed: "远端 skill 安装失败，请稍后重试。",
    hubSkillRemoteRefresh: "刷新",
    hubSkillRemoteSearchPlaceholder: "搜索远端 skill",
    hubSkillUploadDropTitle: "点击选择 zip，或拖拽到这里",
    hubSkillUploadDropHint: "仅支持 .zip，且压缩包内必须只包含一个合法 skill。",
    hubSkillUploadChoose: "选择 zip",
    hubSkillUploadSubmitting: "正在上传...",
    hubSkillUploadSubmit: "上传",
    hubSkillUploadFailed: "Skill 上传失败，请稍后重试。",
    hubSkillSystemBadge: "内建",
    hubAllTab: "全部",
    ...
    hubDeleteSkill: "删除",
    hubDeleteSkillConfirmAction: "删除",
    hubDeleteSkillConfirmMessage: "确认删除技能“{name}”？此操作无法撤销。",
    hubSkillDeleteFailed: "Skill 删除失败，请稍后重试。",
    yourView: "你的视图",
    activeNow: "当前在线",
    totalThreads: "房间总数",
    teamMembers: "团队成员",
    ...
    taskCreateSubtitle: "填写标题、描述并选择团队。",
    ...
    status: "状态",
    modelsSection: "模型",
    modelProviderAdd: "添加 OpenAI API",
    ...
    modelProviderBaseURLRequired: "Base URL 不能为空。",
    ...
    modelProviderCreateFailed: "创建模型提供方失败，请重试。",
    modelProviderCreateIdentityDescription: "为侧边栏和 Agent 选择器设置一个清晰名称。",
    modelProviderCreateIdentityTitle: "身份",
    modelProviderCreateSubtitle: "添加一个 OpenAI 兼容 API 提供方。",
    modelProviderCreateTitle: "添加模型提供方",
    ...
    modelProviderBuiltinSettings: "内置模型提供方设置",
    modelProviderCustomSettings: "OpenAI 兼容提供方设置",
  ...
  en: {
    ...
    configSettingsHubOfficialURL: "Official hub URL",
    ...
    hubSkillsLoading: "Loading skills...",
    hubSkillsEmpty: "No skills available yet.",
    hubSkillsLoadFailed: "Failed to load skills. Please try again later.",
    hubSkillFilesLoading: "Loading skill files...",
    hubSkillFilesEmpty: "This skill does not have any files yet.",
    hubSkillFilesLoadFailed: "Failed to load skill files. Please try again later.",
    hubSkillPreviewTitle: "Select a file to preview",
    hubSkillPreviewHint: "Choose a skill file from the tree on the left to view its content",
    hubSkillFileLoadFailed: "Failed to load the skill file content. Please try again later.",
    hubSkillUpload: "Upload skill",
    hubSkillUploadSubtitle: "Upload a zip file, or choose a skill from the official remote list.",
    hubSkillUploadZipTab: "Upload zip",
    hubSkillRemoteInstallTab: "Remote install",
    hubSkillRemoteSkillsLoading: "Loading remote skills...",
    hubSkillRemoteSkillsEmpty: "No remote skills yet.",
    hubSkillRemoteSkillsLoadFailed: "Failed to load remote skills. Please try again later.",
    hubSkillRemoteInstallAction: "Install",
    hubSkillRemoteInstalling: "Installing...",
    hubSkillRemoteInstallFailed: "Failed to install the remote skill. Please try again later.",
    hubSkillRemoteRefresh: "Refresh",
    hubSkillRemoteSearchPlaceholder: "Search remote skills",
    hubSkillUploadDropTitle: "Click to choose a zip, or drag it here",
    hubSkillUploadDropHint: "Only .zip files are supported, and the archive must contain exactly one valid skill.",
    hubSkillUploadChoose: "Choose zip",
    ...
    taskCreateSubtitle: "Enter a title and description, then choose a team.",
    ...
    modelProviderAdd: "Add OpenAI API",
    ...
    modelProviderCreateFailed: "Failed to create model provider. Please retry.",
    ...
    modelProviderBuiltinSettings: "Built-in provider settings",
