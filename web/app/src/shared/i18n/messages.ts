export const messages = {
  zh: {
    ...
    threadsSection: "话题",
    noThreads: "还没有话题。",
    tasksSidebarHint: "跨 room 的 team tasks 会在主面板中展示。",
    tasksPageTitle: "Tasks",
    tasksPageSubtitle: "跨 room 查看当前系统中的 team tasks。",
    tasksRefresh: "刷新任务",
    tasksLoading: "正在加载任务...",
    tasksLoadFailed: "任务加载失败，请稍后重试。",
    tasksEmpty: "当前还没有 team task。",
    tasksEmptyHint: "创建 team task 后，这里会显示跨 room 的统一列表。",
    tasksListLabel: "全部任务",
    ...
    createRoom: "创建房间",
    deleteRoom: "删除房间",
    deleteDirectMessage: "删除私信",
    deleteRoomConfirmTitle: "删除房间？",
    deleteRoomConfirmDescription: "确定要删除房间“{name}”吗？删除后聊天记录和房间内容将无法恢复。",
    deleteDirectMessageConfirmTitle: "删除私信？",
    deleteDirectMessageConfirmDescription: "确定要删除与“{name}”的私信吗？删除后聊天记录将无法恢复。",
    confirmDelete: "确认删除",
    deleting: "删除中...",
    deleteConversationFailed: "删除失败，请稍后重试。",
  ...
  en: {
    ...
    tasksSidebarHint: "Cross-room team tasks are available in the main panel.",
    tasksPageTitle: "Tasks",
    tasksPageSubtitle: "Browse team tasks across rooms from one place.",
    ...
    tasksEmptyHint: "Created team tasks will appear here across rooms.",
    tasksListLabel: "All tasks",
    ...
    deleting: "Deleting...",
    deleteConversationFailed: "Failed to delete. Please try again later.",
