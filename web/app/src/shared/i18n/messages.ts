export const messages = {
  zh: {
    ...
    csghubSigningIn: "登录中...",
    csghubSignOut: "退出",
    csghubLoginRequired: "登录个人账号后可使用 CSGHub sandbox。",
    csghubLoginPending: "等待授权",
    csghubLoginPendingDetail: "请在 CSGHub 页面完成授权。",
    csghubLoginFailed: "CSGHub 登录失败，请重试。",
    csghubLogoutFailed: "CSGHub 退出失败，请重试。",
    csghubStatusFailed: "读取 CSGHub 登录状态失败。",
    csghubLoginTimedOut: "CSGHub 授权超时，请重新登录。",
    ...
    hubSkillUploadSubtitle: "选择或拖拽一个 zip 文件，系统会校验并安装到全局 skills 目录。",
  ...
  en: {
    ...
    csghubLoginRequired: "Sign in with a personal account to use CSGHub sandbox.",
    csghubLoginPending: "Waiting for auth",
    csghubLoginPendingDetail: "Finish authorization in the CSGHub page.",
    csghubLoginFailed: "CSGHub sign-in failed. Please retry.",
    csghubLogoutFailed: "CSGHub sign-out failed. Please retry.",
    csghubStatusFailed: "Failed to read CSGHub sign-in status.",
    csghubLoginTimedOut: "CSGHub authorization timed out. Please sign in again.",
    ...
    hubSkillUploadSubtitle:
      "Choose or drag a zip file. It will be validated and installed into the global skills directory.",
