export const messages = {
  zh: {
    ...
    agentInstructionsPlaceholder: "描述这个 Agent 应如何工作、避免什么，以及何时请求确认。",
    agentImage: "镜像",
  ...
  en: {
    ...
    agentInstructionsPlaceholder: "Describe how this agent should work, what to avoid, and when to ask for confirmation.",
    agentImage: "Image",
