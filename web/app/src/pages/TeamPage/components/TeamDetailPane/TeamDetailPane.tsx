...
export function TeamDetailPane({
  ...
  const members = memberIDs.map((memberID) => memberDisplay(memberID, agents, usersById, team.lead_participant_id));
  ...
  const existingTeamAgentIDs = teamAgentIDs.filter(
    (agentID) => roomMemberIDs.has(agentID) || agentID === team.lead_participant_id,
  );
                ...
                {teamAgents.length ? (
                  <>
                    ...
                    {teamAgents.map((agent) => {
                      ...
                      const inTeam = roomMemberIDs.has(agentID) || agentID === team.lead_participant_id;
                      return (
      ...
      <div className="team-detail-layout">
        <aside className="team-detail-summary">
          ...
          <div className="team-detail-fields">
            <DetailField label={t("teamLeadLabel")} value={memberName(team.lead_participant_id, agents, usersById)} />
...
function teamMemberIDs(team: WorkspaceTeam, room: IMConversation | null | undefined): string[] {
  ...
  if (team.lead_participant_id) {
    ids.add(team.lead_participant_id);
  }
...
function memberDisplay(
  ...
  return {
    ...
    leader: memberID === leadParticipantID,
    name,
