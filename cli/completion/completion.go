...
func participantSpec(name string) CommandSpec {
	return CommandSpec{
		Name:    name,
		Summary: "Manage channel participants.",
		Children: []CommandSpec{
			{
				Name:    "list",
				Summary: "List participants",
				Flags: append(channelFlags(),
					FlagSpec{Name: "type", TakesValue: true, Values: []string{"human", "agent", "notification"}},
			...
			},
			{
				...
				Flags: append(channelFlags(),
					...
					FlagSpec{Name: "type", TakesValue: true, Values: []string{"human", "agent", "notification"}},
					FlagSpec{Name: "channel-user-ref", TakesValue: true},
					FlagSpec{Name: "channel-user-kind", TakesValue: true, Values: []string{"local_user_id", "open_id"}},
					FlagSpec{Name: "channel-app-ref", TakesValue: true},
					FlagSpec{Name: "bind", TakesValue: true, Values: []string{"create", "reuse", "none"}},
					FlagSpec{Name: "agent-id", TakesValue: true},
					FlagSpec{Name: "role", TakesValue: true, Values: roleValues()},
					FlagSpec{Name: "runtime", TakesValue: true},
					FlagSpec{Name: "image", TakesValue: true},
					FlagSpec{Name: "from-template", TakesValue: true},
					FlagSpec{Name: "model-id", TakesValue: true},
					FlagSpec{Name: "env", TakesValue: true},
				),
			},
			{
				Name:    "delete",
			...
			{
				Name:    "bind",
				Summary: "Bind external identity to participant",
				Flags: append(feishuChannelFlags(),
					FlagSpec{Name: "feishu-kind", TakesValue: true, Values: []string{"human", "bot"}},
					FlagSpec{Name: "agent", TakesValue: true},
					FlagSpec{Name: "name", TakesValue: true},
					FlagSpec{Name: "admin"},
					FlagSpec{Name: "open-id", TakesValue: true},
