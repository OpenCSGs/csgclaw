...
After rapid theme changes settle, the latest taskbar and tray icons are applied
again so delayed Explorer refreshes cannot leave the visible taskbar button on
an earlier theme.
